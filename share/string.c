...
void
lf_open_string_literal(void)
{
    st_string_literal_buffer_size = 0;
}

void
lf_add_string_literal(int letter)
{
...
void
lf_reset_string_literal_buffer(void)
{
...
char *
lf_close_string_literal(void)
{
    char *new_str;

    new_str = lf_malloc(st_string_literal_buffer_size + 1);
...
char *
lf_create_identifier(char *str)
{
    char *new_str;

    new_str = lf_malloc(strlen(str) + 1);
